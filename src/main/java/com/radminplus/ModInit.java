...
public class ModInit implements ModInitializer {
	...
	public static GameRule<Integer> RULE_MAXONLINE;
	...
	public void onInitialize() {
		try {
			...
			RULE_MAXONLINE = Registry.register(
				BuiltInRegistries.GAME_RULE,
				"maxonline",
				new GameRule<>(
					GameRuleCategory.PLAYER,
					GameRuleType.INT,
					com.mojang.brigadier.arguments.IntegerArgumentType.integer(1, 99999),
					GameRuleTypeVisitor::visitInteger,
					com.mojang.serialization.Codec.intRange(1, 99999),
					val -> val,
					20,
					FeatureFlagSet.of()
				)
		...
		net.fabricmc.fabric.api.networking.v1.ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
			...
			SkinManager.fetchAndApplySkin(player);
